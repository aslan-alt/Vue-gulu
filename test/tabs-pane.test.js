...
describe('Tabs', () => {
    ...
    it('子组件只能是tabs-head 和tabs-body', () => {
        ...
        <g-tabs selected="finance">
            <g-tabs-head>
                <g-tabs-item name="woman">人物</g-tabs-item>
                <g-tabs-item name="finance"> 财经</g-tabs-item>
                <g-tabs-item name="sports">体育 </g-tabs-item>
            </g-tabs-head>
            <g-tabs-body>
                <g-tabs-pane name="woman">人物相关资讯</g-tabs-pane>
        ...
        vm.$nextTick(() => {
            let selectedElement = vm.$el.querySelector(`.tabs-item[data-name="finance"]`)
